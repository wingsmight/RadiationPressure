...
{
    public const float APLHA = 1.0f; // reflection coefficient
    public const float HI = 1.0f; // transmittance
    public const float BETA = 1.0f; // optical return loss (ORL) coefficient
    public const float RHO = 1.0f; // mirror reflectivity
