...
namespace Battlehub.ProBuilderIntegration
{
    sealed class PBBounds2D
    {
        ...
        public PBBounds2D(Vector2 center, Vector2 size)
        {
            this.center = center;
            this.size = size;
        }
        ...
        public PBBounds2D(IList<Vector2> points)
        {
        ...
        public PBBounds2D(IList<Vector2> points, IList<int> indexes)
        {
        ...
        internal PBBounds2D(Vector3[] points, Edge[] edges)
        {
            float xMin = 0f,
                                    xMax = 0f,
                                    yMin = 0f,
        ...
        public PBBounds2D(Vector2[] points, int length)
        {
            float xMin = 0f,
                                  xMax = 0f,
                                  yMin = 0f,
